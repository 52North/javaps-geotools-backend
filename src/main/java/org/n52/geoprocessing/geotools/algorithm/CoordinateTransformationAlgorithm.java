...
/**
 * This algorithm transforms GML featureCollection from a source epsg into a GML
 * featureCollection of a target_epsg
 *
 * @author Benjamin Pross, code transformed from 52°North WPS 4.0 by Maurin Radtke
 *
 */
@Algorithm(
        version = "1.1.0")
public class CoordinateTransformationAlgorithm {
    ...
    public void runAlgorithm() {
        ...
        try {
            ...
            throw new RuntimeException("Could not determine source CRS. Valid EPSG code needed.", e);
        }
        ...
        try {
            ...
            while (featureIterator.hasNext()) {
                ...
                Feature newFeature = createFeature(feature.getID(), newGeometry, feature.getProperties(), featureType);
    ...
    private Feature createFeature(String id,
        ...
        Feature feature = gtHelper.createFeature(id, geometry, featureType, properties);
