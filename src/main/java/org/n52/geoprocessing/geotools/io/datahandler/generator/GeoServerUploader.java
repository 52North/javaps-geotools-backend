...
@Properties(propertyFileName = "geoserver.properties", defaultPropertyFileName = "geoserver.default.properties")
public class GeoServerUploader implements ConfigurableClass{
    ...
    public String uploadShp(File file, String storeName) throws HttpException,
            IOException {
        String target = geoServerURL + "/rest/workspaces/N52/datastores/" + storeName
                + "/file.shp";
    ...
    private String sendPutRequest(String target,
            InputStream request, String contentType) throws ClientProtocolException, IOException {
